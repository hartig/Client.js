...
brTPFClient.prototype.getFragmentByPatternAndSolMaps = function (tp, solMapSet) {
  ...
  var canonicalizedTP = canonicalizeTP(tp);
  var usedPrefixes = {};
  var canonicalizedSolMapSet = canonicalizeAndReduceSolMapSet( solMapSet, tp, canonicalizedTP, this._prefixes, usedPrefixes );
  ...
  function canonicalizeAndReduceSolMapSet( solMapSet, origTP, canonicalizedTP, allPrefixes, usedPrefixes ) {
    ...
    // additionally, remove bindings with literals
