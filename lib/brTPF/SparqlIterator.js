...
var SparqlParser = require('sparqljs').Parser,
   ...
   BGPIterator = require('./StaticBGPIterator'),
    // BGPIterator = require('./DynamicBGPIterator'),
...
function SparqlGroupIterator(source, group, options) {
  ...
  switch (group.type) {
  case 'bgp':
    options.fragmentsClient._numberOfTriplePatternsInQuery += group.triples.length;
    return new BGPIterator(source, group.triples, options);
  case 'group':
