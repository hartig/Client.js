...
// ------
// I replaces the following line by the next one to avoid errors for queries
// that have aggregation functions in the SELECT clause.
//                                                        --Olaf
      //this._writeHead(variables.map(function (v) { return v.substring(1); }));
      this._writeHead(variables.map(function (v) { return '' + v; }));
// ------
